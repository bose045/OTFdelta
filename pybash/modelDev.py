...
model_path1 = '/gpfs/u/home/XXXX/XXXXxxxx/scratch-shared/PolyGroup/maceOTFdelta/Autolearn/latestModel/seed0/MACE_model.model'
model_path2 = '/gpfs/u/home/XXXX/XXXXxxxx/scratch-shared/PolyGroup/maceOTFdelta/Autolearn/latestModel/seed1/MACE_model.model'
model_path3 = '/gpfs/u/home/XXXX/XXXXxxxx/scratch-shared/PolyGroup/maceOTFdelta/Autolearn/latestModel/seed2/MACE_model.model'
...
for i in range(0, len(frames)):
    ...
    if i%1==0:
        ...
        frame = frames[i]
        #print(frame)
        MCcalc1 = MACECalculator(model_paths=model_path1, device='cuda')
        MCcalc2 = MACECalculator(model_paths=model_path2, device='cuda')
        MCcalc3 = MACECalculator(model_paths=model_path3, device='cuda')
...
plt.savefig(f'hist_max_deviation_{sysNum}.pdf', format='pdf',bbox_inches='tight')
...
plt.savefig(f'scatter_max_deviation_{sysNum}.pdf', format='pdf',bbox_inches='tight')
