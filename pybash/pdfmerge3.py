...
# Example usage
pdf_files = [f"sys{i}/abs_hist_max_deviation_{i}.pdf" for i in range(8) if os.path.exists(f"sys{i}/hist_max_deviation_{i}.pdf")]
print(pdf_files)
print(f"number of pdf files {len(pdf_files)}")

output_pdf_path = f"abs_err_merged_single_page_{iteration}.pdf"
