...
# python /gpfs/u/home/XXXX/XXXXxxxx/scratch-shared/dpdatajdftx/dpdata/jdftx/jdftxoutToXYZstep1.py 2so3mini.xyz > conversionInfo


def main(xyzOut):
    pattern = r'*Delta.jdftxout'
    with open(xyzOut, 'w') as f:
        for pathAndFilename in sorted(glob.iglob(os.path.join(os.getcwd(), pattern))):
            ...
            unique_atom_names, ions_per_type, atom_types, all_cells, all_coords, all_energies, all_forces = dpdata.jdftx.jdftxout.get_frames(fname, step = 1, convergence_check=False)
